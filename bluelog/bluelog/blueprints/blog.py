from flask import Blueprint, render_template, request, current_app, url_for, redirect, flash, abort, make_response
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        if current_user:
            ...
            flash('Thanks,your comment will be published after viewed.',
                  'info')
